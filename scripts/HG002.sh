...
SPARK_MASTER=cgbs
JAR_FOLDER=/seqslab/NA12878-novaseq-test
ADAM_JAR=${JAR_FOLDER}/adam-assembly-1.0.0-qual.jar
CONNECTEDREADS_JAR=${JAR_FOLDER}/connectedreads-1.0.0.jar
READ1=/seqslab/atsai/data/HG002/HG002-NA24385-50x_1.fastq.gz
READ2=/seqslab/atsai/data/HG002/HG002-NA24385-50x_1.fastq.gz
HDFS_OUTPUT=./HG002
...
OUTPUT_FASTQ=/seqslab/atsai/data/HG002/HG002_ConnectedReads.fastq.gz

hadoop fs -rm -r ${CHUNK_FOLDER}
python3 fq_upload.py -1 ${READ1} -2 ${READ2} -o ${CHUNK_FOLDER}
