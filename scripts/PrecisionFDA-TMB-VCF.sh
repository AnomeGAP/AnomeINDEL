...
#  python $SVM/tools/grid.py -log2c -5,5,1 -log2g -4,0,1 -v 5 -svmtrain $SVM/svm-train -gnuplot gnuplot -s 3 ~/data/PrecisionFDA/TMB/TMB2/training${j}.scale
#  # panel1 - 32.0 1.0 113.8
#  # panel2 - 16.0 1.0 117.28
#  # panel3 - 32.0 1.0 120.78
#done

#${SVM}/svm-train -s 3 -c 32 -g 1.0 ~/data/PrecisionFDA/TMB/TMB2/training1.scale ~/data/PrecisionFDA/TMB/TMB2/training1.model
#${SVM}/svm-train -s 3 -c 16 -g 1.0 ~/data/PrecisionFDA/TMB/TMB2/training2.scale ~/data/PrecisionFDA/TMB/TMB2/training2.model
#${SVM}/svm-train -s 3 -c 32 -g 1.0 ~/data/PrecisionFDA/TMB/TMB2/training3.scale ~/data/PrecisionFDA/TMB/TMB2/training3.model
